...
const uploadServiceImage = require('../middlewares/uploadServiceImage');
...
router.put('/updateServiceFile', isAdminMiddleware, uploadServiceImage.single('serviceFile'), mainController.updateServiceFile)
